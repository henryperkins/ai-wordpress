...
* [openclaWP](https://github.com/lezama/openclawp) - WordPress-native AI agents built on Automattic/agents-api and the WP 7.0 AI Client: chat block, REST chat, deterministic workflows, per-turn cost dashboard, WhatsApp connector, and a per-agent MCP server endpoint so Claude Code / Cursor can call site abilities. [Try it in Playground](https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/lezama/openclawp/main/.wordpress-org/blueprints/blueprint.json).
